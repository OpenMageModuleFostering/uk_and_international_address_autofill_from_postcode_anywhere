...
(function () {
    var n = window.pca = window.pca || {}; n.CountryList = function (t, i) {
        ...
        { iso2: "ZW", iso3: "ZWE", name: "Zimbabwe", flag: 219}], r.load = function () { var o, t, f, i, u, s, e; if (n.addClass(r.autocomplete.element, "countrylist"), r.options.codesList) { for (o = r.options.codesList.replace(/\s/g, "").split(","), t = [], r.autocomplete.clear(), f = 0; f < o.length; f++) for (i = 0; i < r.countries.length; i++) if (r.countries[i].iso2 == o[f] || r.countries[i].iso3 == o[f]) { t.push(r.countries[i]); break } if (r.options.fillOthers) for (u = 0; u < r.countries.length; u++) { for (s = !1, e = 0; e < t.length; e++) r.countries[u].iso3 == t[e].iso3 && (s = !0); s || t.push(r.countries[u]) } r.autocomplete.clear().add(t, r.template, r.change) } else r.autocomplete.clear().add(r.countries, r.template, r.change); r.autocomplete.list.collection.all(function (t) { r.setFlagPosition(t.element.firstChild, t.data.flag), t.tag += " " + n.formatTag(t.data.iso3 + (t.data.alternates ? " " + t.data.alternates.join(" ") : "")) }), r.autocomplete.listen("focus", function () { r.autocomplete.showAll() }), r.options.defaultCode && (r.country = r.find(r.options.defaultCode)), r.country = r.country || r.first(), r.fire("load") }, r.find = function (n) { return (r.autocomplete.list.collection.first(function (t) { return t.data.iso2 == n || t.data.iso3 == n || t.data.name == n || u(t, n) }) || {}).data }, r.first = function () { return r.autocomplete.list.collection.first().data }, r.change = function (n) { n && (r.country = n, r.fire("change", r.country)) }, r.setFlagPosition = function (n, t) { n.style.backgroundPosition = "-1px -" + (t * 16 + 2) + "px" }, r.flag = function () { function t(n) { r.setFlagPosition(i, n.flag) } var i = n.create("div", { className: "flag" }); return t(r.country), r.listen("change", t), i }, r.setCountry = function (n) { return r.change(r.find(n)), r }, r.setCountryByIP = function (t) { function i(n) { n.length && n[0].Iso3 && r.setCountry(n[0].Iso3) } t && n.fetch("Extras/Web/Ip2Country/v1.10", { Key: t }, i) }, r.load()
    } 
})();
(function () { var n = window.pca = window.pca || {}; n.fieldMode = { DEFAULT: 3, SEARCH: 1, POPULATE: 2, PRESERVE: 4, COUNTRY: 8 }, n.Address = function (t, i) { function u(n) { for (var i = {}, t = 0; t < n.length; t++) (n[t].FieldGroup == "Common" || n[t].FieldGroup == "Country") && (i[n[t].FieldName] = n[t].FormattedValue); return i } var r = new n.Object(this); r.messages = { DIDYOUMEAN: "Did you mean:", NORESULTS: "Sorry, no results were found", NOADDRESS: "Sorry, we could not find this address", SERVICEERROR: "Service Error:", COUNTRYSELECT: "Country Select" }, r.templates = { AUTOCOMPLETE: "{Match}<b>{Suggestion}</b>", AUTOCOMPLETEFIND: "<b>{Suggestion}</b>" }, r.fields = t || [], r.options = i || {}, r.key = r.options.key || "", r.options.countries = r.options.countries || {}, r.options.countries.defaultCode = r.options.countries.defaultCode || "" || "" || "GBR", r.options.list = r.options.list || {}, r.options.bar = r.options.bar || {}, r.countryCode = r.options.countries.defaultCode, r.first = !1, r.autocomplete = null, r.countrylist = null, r.load = function () { function u() { var t = n.getValue(r.autocomplete.field); t && !r.first && (r.first = !0, r.search(t)) } for (var a = [], v = [], s = !1, t, h, p, e, y, f, i, l, c, o = 0; o < r.fields.length; o++) (t = r.fields[o], t.mode = t.mode || n.fieldMode.DEFAULT, n.inputField(t.element)) && (t.mode & n.fieldMode.COUNTRY ? v.push(t.element) : t.mode & n.fieldMode.SEARCH && a.push(t.element)); r.autocomplete = new n.AutoComplete(a, r.options.list), r.autocomplete.listen("keyup", function (n) { (n == 8 || n > 36) && u() }), r.autocomplete.listen("focus", r.reset), r.autocomplete.listen("dblclick", u), r.autocomplete.list.listen("filter", function () { r.search(n.getValue(r.autocomplete.field)) }), r.autocomplete.listen("delete", function () { r.first = !1 }), r.countrylist = new n.CountryList(v, r.options.countries), r.countrylist.listen("change", function (n) { r.countryCode = n && n.iso3 ? n.iso3 : r.options.countries.defaultCode, s && (r.autocomplete.field.focus(), u()), r.countrylist.autocomplete.hide(), r.fire("country", n) }), r.countrylist.autocomplete.listen("hide", function () { s = !1 }), h = n.create("div", { className: "flagbutton" }), p = r.countrylist.flag(), h.appendChild(p), r.autocomplete.footer.setContent(h).show(), n.listen(h, "click", function () { r.autocomplete.hide(), r.countrylist.autocomplete.position(r.autocomplete.field), r.countrylist.autocomplete.showAll(), r.countrylist.autocomplete.hover = !0, s = !0 }), e = n.create("div", { className: "flagbutton" }), y = r.countrylist.flag(), e.appendChild(y), r.countrylist.autocomplete.footer.setContent(e).show(), n.listen(e, "click", function () { s && (r.autocomplete.field.focus(), u()), r.countrylist.autocomplete.hide() }), f = n.create("div", { className: "pcamessage disableselect", innerHTML: r.messages.COUNTRYSELECT }), r.autocomplete.footer.setContent(f), i = n.create("a", { href: "http://www.postcodeanywhere.co.uk", target: "_blank" }), l = n.create("div", { className: "pcalogo" }), i.appendChild(l), r.autocomplete.footer.setContent(i), r.showFooterLogo = function () { i.style.display = "", f.style.display = "none" }, r.showFooterMessage = function () { i.style.display = "none", f.style.display = "" }, c = n.create("div", { className: "pcamessage disableselect", innerHTML: r.messages.COUNTRYSELECT }), r.countrylist.autocomplete.footer.setContent(c) }, r.search = function (t) { function i(n) { n.length ? r.showresults(n, r.templates.AUTOCOMPLETE) : r.noresults() } r.fire("search", t), t && n.fetch("CapturePlus/Interactive/AutoComplete/v2.00", { Key: r.key, Country: r.countryCode, SearchTerm: t, $block: !0, $cache: !0 }, i, r.error) }, r.lookup = function (t) { function i(n) { n.length ? r.showresults(n, r.templates.AUTOCOMPLETEFIND) : r.noresults() } n.fetch("CapturePlus/Interactive/AutoCompleteFind/v2.00", { Key: r.key, Id: t }, i, r.error) }, r.retrieve = function (t) { function i(n) { n.length ? r.populate(n) : r.error(r.messages.NOADDRESS) } n.fetch("CapturePlus/Interactive/RetrieveById/v2.00", { Key: r.key, Id: t }, i, r.error) }, r.error = function (n) { r.fire("error", n); throw r.messages.SERVICEERROR + " " + n; }, r.showresults = function (n, t) { r.autocomplete.clear().add(n, t, r.select).show(), r.autocomplete.header.hide(), r.showFooterLogo() }, r.noresults = function () { r.reset(), r.autocomplete.show(), r.autocomplete.header.setText(r.messages.NOADDRESS).show(), r.showFooterMessage() }, r.select = function (n) { r.fire("select", n), n.IsRetrievable ? r.retrieve(n.Id) : r.lookup(n.Id) }, r.populate = function (t) { var f, i; for (t = u(t), r.autocomplete.hide(), r.fire("prepopulate", t), f = 0; f < r.fields.length; f++) (i = r.fields[f], i.mode & n.fieldMode.POPULATE) && (i.mode & n.fieldMode.PRESERVE && n.getValue(i.element) && r.autocomplete.field != n.getElement(i.element) || n.setValue(i.element, t[i.field])); r.first = !1, r.fire("populate", t) }, r.getAddressLine = function (n, t, i, r) { var u, e = "", o, s, f; if (r = r && !!n.Company, r) { if (t == 1 && i > 1) return n.Company; t == 1 && i == 1 ? e = n.Company : (t--, i--) } for (u = n.Line1 ? n.Line2 ? n.Line3 ? n.Line4 ? n.Line5 ? 5 : 4 : 3 : 2 : 1 : 0, o = Math.floor(1 + (u / i + (i - (t - 1)) / i) * (t - 1)), s = Math.floor(u / i + (i - t) / i), f = 0; f < s; f++) e += (e ? ", " : "") + (n["Line" + (f + o)] || ""); return e }, r.setCountry = function (n) { return r.countrylist.setCountry(n), r }, r.setCountryByIP = function () { return r.countrylist.setCountryByIP(r.key), r }, r.clear = function () { for (var t = 0; t < r.fields.length; t++) n.setValue(r.fields[t].element, ""); return r.fire("clear"), r }, r.reset = function () { return r.autocomplete.list.clear().hide(), r.autocomplete.header.hide(), r.showFooterMessage(), r.first = !1, r }, n.ready(r.load) } })()